   ...
   public function createTables(){
        ...
        if($this->wpdb->get_var("SHOW TABLES LIKE '$this->events_table'") != $this->events_table) {
            $sql[] = "CREATE TABLE " .$this->events_table."(
                ...
                attribute_AGERANGE varchar(255) NULL,
                attribute_EVENTSUBJECT varchar(255) NULL,
                attribute_EVENTTYPE varchar(255) NULL,
                attribute_ONLINE varchar(255) NULL,
                attribute_TRIGGERWARNINGTAG varchar(255) NULL,
                attribute_VENUE varchar(255) NULL,
                attribute_FAMILYFRIENDLY varchar(255) NULL,
                attribute_FREEFORMEMBERS varchar(255) NULL,
                attribute_SCHOOLSKEYSTAGE varchar(255) NULL,
                attribute_KS1TOPICS varchar(255) NULL,
                attribute_KS3TOPICS varchar(255) NULL,
